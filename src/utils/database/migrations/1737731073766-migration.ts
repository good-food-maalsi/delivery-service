...
export class Migration1737731073766 implements MigrationInterface {
    name = 'Migration1737731073766'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."deliveries_status_enum" AS ENUM('pending', 'in_progress', 'delivered')`);
